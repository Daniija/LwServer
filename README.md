...
To have a local copy of the project to work on clone the repository using the command `git clone https://github.com/Daniija/LwServer.git in the terminal.
...
in the application, all database setup should be under the utils folder.

### server
in the application the app.ts should be at the root of the application. 
